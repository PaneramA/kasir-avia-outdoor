    ...
    <div className="space-y-6 pt-0 pb-4 sm:pb-5">
      ...
      <section className="rounded-md border border-border bg-card-bg p-4 sm:p-6">
        ...
        {isLoading ? (
          ...
          <div className="rounded-md border border-border bg-bg-main p-4 text-center text-text-muted">Belum ada cabang.</div>
        ) : (
          <div className="space-y-3">
            {branches.map((branch) => (
              <article key={branch.id} className="rounded-md border border-border bg-bg-main p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <select
                      className="rounded-md border border-border bg-bg-main p-2 text-sm text-text-main outline-none focus:border-accent"
                      value={branch.status}
