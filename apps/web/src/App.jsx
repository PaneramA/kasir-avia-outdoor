      ...
      <main className="relative flex min-w-0 flex-1 flex-col overflow-y-auto px-4 sm:px-6 lg:min-h-0 lg:overflow-hidden lg:px-10">
        ...
        <div id="content-view" className="pb-6 sm:pb-10 lg:min-h-0 lg:flex-1 lg:overflow-y-auto">
          ...
          <Routes>
            ...
            />
            <Route
              path={APP_ROUTES.adminRegistrations}
              element={isAdminLikeUser ? <AdminRegistrations /> : <Navigate to={APP_ROUTES.dashboard} replace />}
            />
            <Route
              path={APP_ROUTES.adminPlans}
              element={isAdminLikeUser ? <AdminPlans /> : <Navigate to={APP_ROUTES.dashboard} replace />}
            />
